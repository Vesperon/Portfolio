        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Vesperon/Navigatu-Intern-Project" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Navigatu Inventory System</h3>
              <p>
              Developed a system that track, manage and monitor the availability, movement and status of items / units MR within the TBI (Navigatu and Tara) and Personnel
              </p>
            </div>
            <footer>
              <ul className="tech-list">
